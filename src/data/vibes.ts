...
const strawberry: Vibe = {
  ...
  sections: [
    { id: 'straw-leaf-l', label: 'Left Leaf', tone: 'dark',
      path: 'M200,135 Q175,108 150,95 Q130,88 118,95 Q112,108 125,125 Q142,142 165,152 Q185,158 200,152 Z' },
    { id: 'straw-leaf-c', label: 'Center Leaf', tone: 'dark',
      path: 'M225,125 Q230,95 240,72 Q248,55 255,52 Q262,55 268,72 Q275,95 278,125 Q265,132 252,135 Q238,132 225,125 Z' },
    { id: 'straw-leaf-r', label: 'Right Leaf', tone: 'dark',
      path: 'M280,135 Q305,108 330,95 Q350,88 362,95 Q368,108 355,125 Q338,142 315,152 Q295,158 280,152 Z' },
    { id: 'straw-body', label: 'Berry', tone: 'accent',
      path: 'M165,155 Q160,165 155,195 Q148,235 150,278 Q155,322 172,358 Q195,395 225,418 Q240,428 255,418 Q285,395 308,358 Q325,322 330,278 Q332,235 325,195 Q320,165 315,155 Q290,148 265,145 Q240,142 215,145 Q190,148 165,155 Z' },
    { id: 'straw-seed1', label: 'Seed 1', tone: 'light', path: circlePath(210, 215, 6) },
    { id: 'straw-seed2', label: 'Seed 2', tone: 'light', path: circlePath(270, 215, 6) },
    { id: 'straw-seed3', label: 'Seed 3', tone: 'light', path: circlePath(240, 260, 6) },
    { id: 'straw-seed4', label: 'Seed 4', tone: 'light', path: circlePath(200, 280, 6) },
    { id: 'straw-seed5', label: 'Seed 5', tone: 'light', path: circlePath(280, 280, 6) },
    { id: 'straw-seed6', label: 'Seed 6', tone: 'light', path: circlePath(225, 330, 6) },
    { id: 'straw-seed7', label: 'Seed 7', tone: 'light', path: circlePath(255, 330, 6) },
    { id: 'straw-seed8', label: 'Seed 8', tone: 'light', path: circlePath(240, 380, 5) },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
