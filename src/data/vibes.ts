...
const elephant: Vibe = {
  ...
  description: 'Big friendly elephant with trunk',
  viewBox: '0 0 480 480',
  sections: [
    { id: 'el-ear', label: 'Ear', tone: 'medium',
      path: 'M108,148 Q82,135 60,145 Q42,162 38,188 Q38,218 48,248 Q62,275 82,292 Q102,305 122,305 Q138,298 145,282 Q148,262 145,238 Q140,212 132,188 Q125,168 115,155 Z' },
    { id: 'el-ear-inner', label: 'Inner Ear', tone: 'light',
      path: 'M105,172 Q88,168 75,178 Q65,192 62,212 Q62,235 72,258 Q82,275 98,285 Q112,288 122,278 Q128,262 128,242 Q125,218 118,198 Q112,182 108,175 Z' },
    { id: 'el-head', label: 'Head', tone: 'dark',
      path: 'M145,148 Q148,122 165,102 Q188,85 215,80 Q245,78 272,85 Q298,98 312,122 Q322,148 318,178 Q312,205 298,228 Q278,248 255,258 Q228,262 205,258 Q178,248 162,228 Q148,205 145,178 Z' },
    { id: 'el-eye', label: 'Eye', tone: 'light', path: circlePath(262, 152, 12) },
    { id: 'el-trunk', label: 'Trunk', tone: 'dark',
      path: 'M255,258 Q268,278 278,305 Q285,332 288,362 Q288,388 282,408 Q275,425 265,435 Q255,442 248,438 Q242,428 238,412 Q235,392 235,368 Q238,342 242,318 Q248,292 248,268 Z' },
    { id: 'el-trunk-tip', label: 'Trunk Tip', tone: 'medium',
      path: 'M248,438 Q242,445 235,448 Q228,448 222,442 Q218,435 222,428 Q228,425 235,428 Q242,432 248,438 Z' },
    { id: 'el-tusk', label: 'Tusk', tone: 'light',
      path: 'M235,282 Q225,298 218,318 Q215,335 218,348 Q222,355 228,352 Q232,342 235,325 Q238,308 238,292 Z' },
    { id: 'el-body', label: 'Body', tone: 'dark',
      path: 'M165,258 Q148,278 138,308 Q130,342 132,378 Q138,408 155,432 Q178,452 210,462 Q248,468 288,465 Q325,458 352,442 Q375,420 385,392 Q392,358 388,322 Q380,288 365,262 Q345,242 318,232 Q295,242 268,252 Q238,258 208,258 Q185,258 168,255 Z' },
    { id: 'el-belly', label: 'Belly', tone: 'medium',
      path: 'M195,345 Q208,325 248,318 Q292,322 312,345 Q322,375 315,405 Q298,432 258,438 Q218,435 198,412 Q185,382 195,345 Z' },
    { id: 'el-leg-fl', label: 'Front Left', tone: 'dark',
      path: 'M175,445 Q168,458 165,472 Q165,482 172,485 Q178,485 182,478 Q185,465 185,452 Q185,448 182,445 Z' },
    { id: 'el-leg-fr', label: 'Front Right', tone: 'dark',
      path: 'M218,458 Q212,468 210,478 Q210,488 218,492 Q225,492 228,485 Q230,475 228,465 Q225,460 222,458 Z' },
    { id: 'el-leg-bl', label: 'Back Left', tone: 'dark',
      path: 'M318,452 Q312,465 310,478 Q310,488 318,492 Q325,492 328,485 Q330,472 328,462 Q325,455 322,452 Z' },
    { id: 'el-leg-br', label: 'Back Right', tone: 'dark',
      path: 'M358,438 Q352,452 350,465 Q350,475 358,478 Q365,478 368,472 Q370,460 368,450 Q365,442 362,438 Z' },
    { id: 'el-tail', label: 'Tail', tone: 'dark',
      path: 'M385,292 Q398,278 412,268 Q425,262 432,265 Q435,272 428,282 Q418,295 405,305 Q395,310 388,305 Z' },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
