...
const cow: Vibe = {
  ...
  sections: [
    { id: 'cow-horn-l', label: 'Left Horn', tone: 'light',
      path: 'M88,78 Q78,52 75,32 Q75,18 82,15 Q90,18 95,32 Q100,52 100,72 Q98,82 92,85 Z' },
    { id: 'cow-horn-r', label: 'Right Horn', tone: 'light',
      path: 'M148,68 Q152,42 160,25 Q168,15 175,18 Q178,28 172,48 Q165,68 155,82 Q148,88 142,82 Z' },
    { id: 'cow-head', label: 'Head', tone: 'medium',
      path: 'M65,155 Q55,125 62,95 Q75,72 100,65 Q128,62 152,72 Q172,88 178,115 Q182,145 172,175 Q158,200 138,215 Q115,225 92,218 Q72,205 65,180 Z' },
    { id: 'cow-ear-l', label: 'Left Ear', tone: 'dark',
      path: 'M62,102 Q42,95 28,102 Q18,115 22,130 Q30,142 48,140 Q60,132 65,118 Z' },
    { id: 'cow-ear-r', label: 'Right Ear', tone: 'dark',
      path: 'M168,92 Q185,85 198,92 Q205,105 200,120 Q190,130 175,128 Q165,120 162,108 Z' },
    { id: 'cow-eye', label: 'Eye', tone: 'dark', path: circlePath(132, 128, 10) },
    { id: 'cow-snout', label: 'Snout', tone: 'light',
      path: 'M92,185 Q102,192 118,195 Q130,192 138,185 Q142,195 138,208 Q128,218 112,222 Q98,218 88,208 Q85,198 88,188 Z' },
    { id: 'cow-body', label: 'Body', tone: 'medium',
      path: 'M158,210 Q178,222 208,232 Q235,238 255,238 Q295,235 335,228 Q372,218 400,205 Q422,188 435,168 Q445,148 445,128 Q440,115 428,112 Q412,115 395,128 Q375,148 358,170 Q342,188 328,200 Q308,210 285,215 Q260,218 238,218 Q215,218 195,212 Q175,205 162,198 Z' },
    { id: 'cow-belly', label: 'Belly', tone: 'light',
      path: 'M200,265 Q215,248 250,242 Q290,245 315,265 Q328,292 322,322 Q308,348 275,358 Q242,358 215,345 Q198,325 198,298 Z' },
    { id: 'cow-spot1', label: 'Spot 1', tone: 'dark',
      path: 'M268,168 Q285,158 305,160 Q322,168 325,188 Q322,208 308,218 Q290,222 275,215 Q262,202 262,185 Z' },
    { id: 'cow-spot2', label: 'Spot 2', tone: 'dark',
      path: 'M372,155 Q388,148 402,155 Q412,168 408,185 Q400,198 385,200 Q370,195 365,182 Q362,168 368,158 Z' },
    { id: 'cow-udder', label: 'Udder', tone: 'light',
      path: 'M280,355 Q285,368 292,375 Q300,378 308,375 Q315,368 318,355 Q312,372 305,378 Q295,378 288,372 Z' },
    { id: 'cow-leg-fl', label: 'Front Left', tone: 'dark',
      path: 'M195,345 L188,392 Q185,400 188,408 Q195,412 202,408 Q205,398 205,388 L208,350 Z' },
    { id: 'cow-leg-fr', label: 'Front Right', tone: 'medium',
      path: 'M238,355 L235,395 Q232,405 235,412 Q242,415 248,412 Q252,402 252,392 L252,358 Z' },
    { id: 'cow-leg-bl', label: 'Back Left', tone: 'dark',
      path: 'M335,348 L332,390 Q328,400 332,408 Q338,412 345,408 Q348,398 348,388 L350,352 Z' },
    { id: 'cow-leg-br', label: 'Back Right', tone: 'medium',
      path: 'M378,335 L375,380 Q372,390 375,398 Q382,402 388,398 Q392,388 392,378 L392,340 Z' },
    { id: 'cow-tail', label: 'Tail', tone: 'dark',
      path: 'M435,168 Q448,155 458,145 Q465,140 468,145 Q468,155 460,168 Q450,178 440,180 Z' },
    { id: 'cow-tail-tuft', label: 'Tail Tuft', tone: 'dark',
      path: 'M468,145 Q475,135 480,130 Q485,132 485,140 Q482,150 475,155 Q470,152 468,148 Z' },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
