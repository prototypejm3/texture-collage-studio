...
const elephant: Vibe = {
  ...
  sections: [
    { id: 'el-ear', label: 'Ear', tone: 'medium',
      path: 'M92,118 Q58,108 35,128 Q15,155 12,192 Q12,232 28,268 Q48,298 78,315 Q102,325 118,318 Q128,305 128,285 Q125,252 118,218 Q112,182 105,152 Z' },
    { id: 'el-ear-inner', label: 'Inner Ear', tone: 'light',
      path: 'M98,148 Q75,142 58,158 Q42,178 40,208 Q42,238 55,265 Q72,288 92,298 Q105,295 108,278 Q108,248 102,218 Q98,185 98,158 Z' },
    { id: 'el-head', label: 'Head', tone: 'dark',
      path: 'M125,92 Q138,55 168,35 Q205,18 242,22 Q278,28 305,52 Q325,82 328,118 Q328,158 315,192 Q298,222 275,242 Q258,252 245,255 L135,248 Q122,228 118,200 Q115,165 118,132 Z' },
    { id: 'el-eye', label: 'Eye', tone: 'light', path: circlePath(272, 105, 15) },
    { id: 'el-trunk', label: 'Trunk', tone: 'dark',
      path: 'M245,255 Q258,282 268,318 Q275,355 275,388 Q272,415 262,435 Q252,448 240,452 Q228,445 222,425 Q218,402 222,375 Q228,342 238,312 Q245,285 248,268 Z' },
    { id: 'el-trunk-tip', label: 'Trunk Tip', tone: 'medium',
      path: 'M240,452 Q228,458 218,455 Q208,448 205,438 Q208,428 218,425 Q228,428 238,438 Q242,445 242,450 Z' },
    { id: 'el-tusk', label: 'Tusk', tone: 'light',
      path: 'M252,278 Q240,298 232,325 Q225,348 228,362 Q232,370 240,365 Q248,352 252,332 Q258,308 258,288 Z' },
    { id: 'el-body', label: 'Body', tone: 'dark',
      path: 'M135,248 Q112,268 100,298 Q90,335 95,372 Q105,402 128,422 Q158,438 198,445 Q245,448 298,442 Q342,432 378,412 Q405,388 418,355 Q425,318 418,280 Q402,248 378,232 Q348,218 315,215 Q290,232 268,248 Q218,255 172,250 Z' },
    { id: 'el-belly', label: 'Belly', tone: 'light',
      path: 'M185,328 Q200,305 245,295 Q292,302 312,328 Q325,358 318,392 Q302,418 262,428 Q225,425 205,405 Q190,375 188,348 Z' },
    { id: 'el-leg-fl', label: 'Front Left Leg', tone: 'dark',
      path: 'M148,422 L140,462 Q138,472 142,478 Q148,480 155,475 Q158,468 158,458 L162,428 Z' },
    { id: 'el-leg-fr', label: 'Front Right Leg', tone: 'medium',
      path: 'M208,442 L205,468 Q202,475 205,480 Q212,482 218,478 Q222,470 222,462 L222,445 Z' },
    { id: 'el-leg-bl', label: 'Back Left Leg', tone: 'dark',
      path: 'M322,438 L318,465 Q315,472 318,478 Q325,482 332,478 Q338,470 335,462 L338,440 Z' },
    { id: 'el-leg-br', label: 'Back Right Leg', tone: 'medium',
      path: 'M378,418 L375,452 Q372,462 375,468 Q382,472 388,468 Q392,458 392,450 L392,422 Z' },
    { id: 'el-tail', label: 'Tail', tone: 'dark',
      path: 'M418,280 Q432,265 445,255 Q455,252 458,258 Q458,268 448,282 Q438,292 428,292 Z' },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
