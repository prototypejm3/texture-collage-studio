...
const bellPepper: Vibe = {
  ...
  sections: [
    { id: 'bp-stem', label: 'Stem', tone: 'dark',
      path: 'M228,95 Q225,72 228,52 Q235,38 245,38 Q255,42 258,62 Q260,82 255,98 Q248,108 240,105 Z' },
    { id: 'bp-lobe-left', label: 'Left Lobe', tone: 'accent',
      path: 'M240,112 Q215,115 190,125 Q162,142 145,168 Q128,200 122,238 Q118,282 125,325 Q135,368 158,402 Q182,428 210,442 Q232,448 240,445 L240,112 Z' },
    { id: 'bp-lobe-right', label: 'Right Lobe', tone: 'accent',
      path: 'M240,112 L240,445 Q248,448 270,442 Q298,428 322,402 Q345,368 355,325 Q362,282 358,238 Q352,200 335,168 Q318,142 290,125 Q265,115 240,112 Z' },
    { id: 'bp-lobe-left-inner', label: 'Left Inner', tone: 'medium',
      path: 'M195,155 Q172,178 158,212 Q148,252 150,295 Q155,338 172,372 Q192,400 215,418 Q225,415 230,408 Q212,388 198,358 Q185,322 182,282 Q180,245 188,212 Q198,185 210,168 Z' },
    { id: 'bp-lobe-right-inner', label: 'Right Inner', tone: 'medium',
      path: 'M285,155 Q308,178 322,212 Q332,252 330,295 Q325,338 308,372 Q288,400 265,418 Q255,415 250,408 Q268,388 282,358 Q295,322 298,282 Q300,245 292,212 Q282,185 270,168 Z' },
    { id: 'bp-bottom-notch', label: 'Bottom', tone: 'dark',
      path: 'M215,442 Q225,448 240,450 Q255,448 265,442 Q258,452 248,458 Q240,460 232,458 Q222,452 215,442 Z' },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
...
const broccoli: Vibe = {
  ...
  viewBox: '0 0 480 480',
  sections: [
    { id: 'br-floret-tl', label: 'Top Left Floret', tone: 'dark',
      path: 'M155,135 Q138,108 148,78 Q165,55 192,52 Q218,58 230,82 Q238,108 228,135 Q218,152 198,158 Q175,158 158,148 Z' },
    { id: 'br-floret-tc', label: 'Top Center Floret', tone: 'accent',
      path: 'M215,105 Q210,75 222,50 Q240,32 262,35 Q282,45 290,72 Q292,100 280,125 Q268,145 248,152 Q228,152 218,138 Z' },
    { id: 'br-floret-tr', label: 'Top Right Floret', tone: 'dark',
      path: 'M282,128 Q278,98 292,72 Q312,55 335,58 Q355,68 362,92 Q365,118 352,142 Q338,158 318,162 Q298,158 288,145 Z' },
    { id: 'br-floret-ml', label: 'Mid Left Floret', tone: 'accent',
      path: 'M140,175 Q125,152 132,125 Q145,108 168,105 Q188,108 200,125 Q208,148 200,172 Q192,192 175,200 Q155,200 142,188 Z' },
    { id: 'br-floret-mr', label: 'Mid Right Floret', tone: 'medium',
      path: 'M305,168 Q298,142 308,118 Q325,102 348,105 Q365,115 372,138 Q375,162 362,182 Q348,198 328,202 Q310,198 302,185 Z' },
    { id: 'br-floret-bl', label: 'Bottom Left Floret', tone: 'medium',
      path: 'M162,210 Q148,192 155,172 Q168,158 188,158 Q208,165 218,185 Q222,208 212,228 Q198,242 178,242 Q160,235 155,220 Z' },
    { id: 'br-floret-bc', label: 'Bottom Center Floret', tone: 'dark',
      path: 'M218,218 Q212,195 222,175 Q238,160 258,162 Q278,172 285,195 Q288,218 278,238 Q262,252 242,252 Q225,248 218,232 Z' },
    { id: 'br-floret-br', label: 'Bottom Right Floret', tone: 'accent',
      path: 'M285,212 Q278,192 285,172 Q298,158 318,160 Q335,168 342,188 Q345,212 335,232 Q322,245 302,248 Q288,242 282,228 Z' },
    { id: 'br-stem', label: 'Stem', tone: 'medium',
      path: 'M208,248 Q202,278 198,312 Q195,348 198,385 Q202,418 210,442 Q222,458 240,462 Q258,458 270,442 Q278,418 282,385 Q285,348 282,312 Q278,278 272,248 Q262,255 248,258 Q232,255 218,248 Z' },
    { id: 'br-stem-branch-l', label: 'Left Branch', tone: 'dark',
      path: 'M208,320 Q195,312 182,308 Q172,308 168,315 Q168,325 178,332 Q192,338 205,335 Z' },
    { id: 'br-stem-branch-r', label: 'Right Branch', tone: 'dark',
      path: 'M272,348 Q285,342 298,338 Q308,338 312,345 Q312,355 302,362 Q288,368 275,362 Z' },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
...
const banana: Vibe = {
  ...
  viewBox: '0 0 480 480',
  sections: [
    { id: 'ban-peel', label: 'Peel', tone: 'accent',
      path: 'M358,108 Q342,92 318,82 Q292,75 265,78 Q235,85 208,102 Q178,125 155,158 Q135,195 122,238 Q112,282 110,325 Q112,362 120,388 Q130,408 145,418 Q158,422 168,415 Q178,405 185,388 Q195,362 205,328 Q218,288 235,252 Q255,218 278,192 Q302,168 325,155 Q348,145 365,142 Q378,142 382,148 Q385,155 378,162 Q368,168 352,172 Q332,178 312,188 Q288,205 268,228 Q248,255 232,288 Q218,322 208,358 Q200,392 198,418 L192,418 Q192,388 198,352 Q208,312 225,272 Q245,235 272,205 Q298,180 325,165 Q348,155 368,152 Q385,152 392,158 Q398,168 392,180 Q382,188 368,192 Z' },
    { id: 'ban-body', label: 'Body', tone: 'accent',
      path: 'M365,142 Q378,135 388,128 Q395,118 392,108 Q385,100 372,98 Q358,100 345,108 Q348,118 355,128 Q360,135 365,142 Z M145,418 Q135,428 125,432 Q118,432 112,425 Q110,415 115,405 Q122,398 132,395 Q138,400 142,408 Z' },
    { id: 'ban-inner', label: 'Inner Curve', tone: 'light',
      path: 'M325,155 Q302,168 278,192 Q255,218 235,252 Q218,288 205,328 Q195,362 185,388 Q178,405 168,415 Q162,412 158,402 Q165,378 178,348 Q195,308 218,272 Q242,238 268,212 Q295,188 318,172 Q335,162 345,158 Z' },
    { id: 'ban-stem', label: 'Stem', tone: 'dark',
      path: 'M372,98 Q378,88 385,80 Q392,75 398,78 Q402,85 398,95 Q392,102 385,105 Q378,102 375,100 Z' },
    { id: 'ban-tip', label: 'Tip', tone: 'dark',
      path: 'M112,425 Q105,435 98,442 Q92,445 88,442 Q85,435 88,428 Q95,420 105,415 Q110,418 112,422 Z' },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
...
const cow: Vibe = {
  ...
  sections: [
    { id: 'cow-horn-l', label: 'Left Horn', tone: 'light',
      path: 'M98,82 Q88,58 82,38 Q80,25 85,20 Q92,20 98,28 Q105,42 108,62 Q108,78 105,88 Z' },
    { id: 'cow-horn-r', label: 'Right Horn', tone: 'light',
      path: 'M142,72 Q148,48 158,32 Q165,22 172,22 Q178,28 175,42 Q168,58 158,75 Q152,85 145,88 Z' },
    { id: 'cow-head', label: 'Head', tone: 'medium',
      path: 'M72,148 Q65,122 72,98 Q85,78 108,72 Q132,72 152,82 Q168,98 172,122 Q175,148 165,172 Q152,192 135,202 Q112,208 92,198 Q75,185 72,165 Z' },
    { id: 'cow-ear-l', label: 'Left Ear', tone: 'dark',
      path: 'M72,105 Q55,98 42,102 Q32,112 35,125 Q42,135 55,135 Q65,128 72,118 Z' },
    { id: 'cow-ear-r', label: 'Right Ear', tone: 'dark',
      path: 'M162,95 Q175,88 188,92 Q195,102 192,115 Q185,125 172,125 Q162,118 158,108 Z' },
    { id: 'cow-eye', label: 'Eye', tone: 'dark', path: circlePath(128, 128, 8) },
    { id: 'cow-nostril', label: 'Nostril', tone: 'dark',
      path: 'M105,178 Q112,182 122,182 Q128,178 132,172 Q128,182 120,188 Q110,188 105,182 Z' },
    { id: 'cow-neck', label: 'Neck', tone: 'medium',
      path: 'M152,195 Q168,208 188,222 Q208,235 225,242 Q238,238 245,232 Q228,218 208,202 Q192,188 175,178 Q165,185 158,192 Z' },
    { id: 'cow-body', label: 'Body', tone: 'medium',
      path: 'M225,242 Q212,258 202,282 Q195,308 195,332 Q198,352 210,365 Q228,375 258,378 Q298,378 338,372 Q372,362 395,345 Q412,325 418,302 Q420,278 412,255 Q398,235 378,222 Q355,215 328,212 Q298,212 268,218 Q248,225 232,235 Z' },
    { id: 'cow-spot1', label: 'Spot 1', tone: 'dark',
      path: 'M275,262 Q292,252 312,252 Q332,258 338,278 Q338,298 325,312 Q308,318 292,312 Q278,302 275,282 Z' },
    { id: 'cow-spot2', label: 'Spot 2', tone: 'dark',
      path: 'M365,268 Q378,262 392,268 Q400,278 398,295 Q392,308 378,312 Q365,308 360,295 Q358,282 362,272 Z' },
    { id: 'cow-udder', label: 'Udder', tone: 'light',
      path: 'M298,372 Q302,382 308,388 Q315,392 322,388 Q328,382 332,372 Q325,385 318,392 Q310,392 302,385 Z' },
    { id: 'cow-leg-fl', label: 'Front Left', tone: 'dark',
      path: 'M218,365 L212,420 Q210,432 215,438 Q222,440 228,435 Q230,425 230,412 L232,372 Z' },
    { id: 'cow-leg-fr', label: 'Front Right', tone: 'medium',
      path: 'M252,375 L248,425 Q245,435 250,440 Q258,442 262,438 Q265,428 265,415 L265,378 Z' },
    { id: 'cow-leg-bl', label: 'Back Left', tone: 'dark',
      path: 'M348,368 L345,418 Q342,430 345,438 Q352,442 358,438 Q362,428 362,415 L362,372 Z' },
    { id: 'cow-leg-br', label: 'Back Right', tone: 'medium',
      path: 'M385,358 L382,410 Q380,422 382,430 Q388,435 395,430 Q398,420 398,408 L398,362 Z' },
    { id: 'cow-tail', label: 'Tail', tone: 'dark',
      path: 'M412,258 Q425,245 438,235 Q448,228 455,232 Q458,238 452,248 Q442,262 428,272 Q418,278 412,272 Z' },
    { id: 'cow-tail-tuft', label: 'Tail Tuft', tone: 'dark',
      path: 'M455,232 Q462,225 468,222 Q475,222 478,228 Q478,238 472,245 Q465,248 458,242 Z' },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
...
const elephant: Vibe = {
  ...
  sections: [
    { id: 'el-ear', label: 'Ear', tone: 'medium',
      path: 'M135,105 Q108,92 82,98 Q58,112 48,138 Q42,168 48,202 Q58,235 78,258 Q102,278 128,282 Q148,278 158,262 Q165,242 162,218 Q155,188 148,162 Q142,138 138,118 Z' },
    { id: 'el-ear-inner', label: 'Inner Ear', tone: 'light',
      path: 'M128,128 Q108,122 92,132 Q78,148 72,172 Q70,198 78,225 Q88,248 105,262 Q122,268 135,258 Q142,242 142,218 Q140,192 135,168 Q130,145 128,132 Z' },
    { id: 'el-head', label: 'Head', tone: 'dark',
      path: 'M158,100 Q162,72 182,52 Q208,35 238,32 Q268,35 292,52 Q312,72 318,100 Q322,132 315,165 Q305,198 288,225 Q268,248 245,258 Q218,262 195,252 Q172,238 158,215 Q148,188 148,158 Q148,128 155,108 Z' },
    { id: 'el-eye', label: 'Eye', tone: 'light', path: circlePath(268, 118, 14) },
    { id: 'el-trunk', label: 'Trunk', tone: 'dark',
      path: 'M245,258 Q258,278 272,308 Q282,338 288,368 Q290,395 285,418 Q278,435 268,445 Q258,452 248,448 Q238,438 232,418 Q228,395 228,368 Q232,338 238,312 Q245,288 248,272 Z' },
    { id: 'el-trunk-curl', label: 'Trunk Curl', tone: 'medium',
      path: 'M248,448 Q238,458 228,462 Q218,462 210,455 Q205,445 210,435 Q218,428 228,432 Q238,438 248,448 Z' },
    { id: 'el-tusk', label: 'Tusk', tone: 'light',
      path: 'M232,285 Q218,305 208,332 Q202,355 205,372 Q210,382 218,378 Q225,365 230,345 Q235,322 238,302 Z' },
    { id: 'el-body', label: 'Body', tone: 'dark',
      path: 'M175,252 Q155,272 142,302 Q132,338 132,375 Q138,405 158,428 Q185,448 222,455 Q265,458 308,452 Q348,442 378,422 Q402,398 412,368 Q418,335 412,298 Q398,265 378,242 Q355,228 325,222 Q298,238 268,252 Q238,258 208,255 Q192,255 178,252 Z' },
    { id: 'el-belly', label: 'Belly', tone: 'medium',
      path: 'M202,332 Q215,308 258,298 Q305,305 325,332 Q338,365 330,398 Q312,428 268,438 Q225,435 205,412 Q192,378 202,342 Z' },
    { id: 'el-leg-fl', label: 'Front Left', tone: 'dark',
      path: 'M178,438 L172,502 Q170,515 175,522 Q182,525 190,520 Q195,510 195,498 L198,448 Z' },
    { id: 'el-leg-fr', label: 'Front Right', tone: 'medium',
      path: 'M228,452 L225,505 Q222,518 225,525 Q232,528 240,525 Q245,515 245,502 L248,458 Z' },
    { id: 'el-leg-bl', label: 'Back Left', tone: 'dark',
      path: 'M332,445 L328,498 Q325,512 328,520 Q335,525 342,520 Q348,510 348,498 L352,452 Z' },
    { id: 'el-leg-br', label: 'Back Right', tone: 'medium',
      path: 'M378,432 L375,488 Q372,502 375,510 Q382,515 390,510 Q395,500 395,488 L398,438 Z' },
    { id: 'el-tail', label: 'Tail', tone: 'dark',
      path: 'M412,298 Q425,282 438,272 Q452,265 458,268 Q462,275 455,288 Q445,302 432,312 Q420,318 415,312 Z' },
    { id: 'el-tail-tuft', label: 'Tail Tuft', tone: 'dark',
      path: 'M458,268 Q465,258 472,252 Q478,252 480,258 Q480,268 475,278 Q468,282 462,275 Z' },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
...
const whale: Vibe = {
  ...
  viewBox: '0 0 480 480',
  sections: [
    { id: 'wh-spout', label: 'Spout', tone: 'light',
      path: 'M188,118 Q182,95 178,72 Q175,52 180,42 Q185,38 190,45 Q195,62 198,82 Q200,100 198,115 Z M205,108 Q202,88 205,68 Q208,52 212,48 Q218,52 218,68 Q215,88 212,105 Z' },
    { id: 'wh-head', label: 'Head', tone: 'dark',
      path: 'M95,235 Q82,205 85,172 Q92,145 112,128 Q138,115 168,112 Q198,115 222,128 Q242,145 252,172 Q258,202 252,235 Q245,255 232,268 Q215,278 195,282 Q168,282 145,275 Q122,262 108,248 Z' },
    { id: 'wh-eye', label: 'Eye', tone: 'light', path: circlePath(172, 195, 14) },
    { id: 'wh-mouth', label: 'Mouth', tone: 'medium',
      path: 'M108,248 Q128,262 155,272 Q182,278 205,275 Q225,268 240,258 Q232,272 215,282 Q195,288 172,288 Q148,285 128,275 Q112,265 105,255 Z' },
    { id: 'wh-body', label: 'Body', tone: 'dark',
      path: 'M252,235 Q268,248 295,258 Q328,268 365,272 Q398,272 422,262 Q442,248 452,228 Q458,208 455,188 Q448,172 432,162 Q412,155 388,158 Q362,165 338,178 Q312,195 288,215 Q268,232 255,242 Z' },
    { id: 'wh-belly', label: 'Belly', tone: 'light',
      path: 'M108,260 Q135,278 175,290 Q218,295 262,288 Q305,278 342,262 Q375,248 398,238 Q412,232 418,228 Q408,248 388,262 Q362,278 332,288 Q298,298 262,302 Q225,302 188,295 Q155,285 128,272 Q108,262 105,258 Z' },
    { id: 'wh-flipper', label: 'Flipper', tone: 'medium',
      path: 'M205,282 Q195,298 182,318 Q172,338 168,352 Q168,362 175,365 Q185,362 198,348 Q212,328 222,308 Q228,292 225,282 Z' },
    { id: 'wh-tail-upper', label: 'Upper Tail', tone: 'dark',
      path: 'M452,228 Q462,215 472,198 Q478,182 480,168 Q478,158 472,155 Q462,158 455,172 Q448,188 445,208 Q445,222 448,228 Z' },
    { id: 'wh-tail-lower', label: 'Lower Tail', tone: 'dark',
      path: 'M452,228 Q462,242 472,258 Q478,275 480,288 Q478,298 472,302 Q462,298 455,285 Q448,268 445,248 Q445,235 448,228 Z' },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
