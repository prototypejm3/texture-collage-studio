...
const cow: Vibe = {
  ...
  description: 'Sturdy cow with horns and spots',
  viewBox: '0 0 480 480',
  sections: [
    { id: 'cow-head', label: 'Head', tone: 'medium',
      path: 'M82,175 Q72,152 78,128 Q88,108 108,100 Q128,95 148,100 Q165,108 172,128 Q178,148 172,172 Q165,192 148,205 Q128,212 108,208 Q88,200 82,185 Z' },
    { id: 'cow-horn-l', label: 'Left Horn', tone: 'light',
      path: 'M88,118 Q78,98 72,78 Q68,62 72,55 Q78,52 85,58 Q92,72 95,92 Q98,108 95,118 Z' },
    { id: 'cow-horn-r', label: 'Right Horn', tone: 'light',
      path: 'M155,108 Q162,88 172,72 Q180,58 185,55 Q192,58 188,68 Q182,85 175,102 Q168,115 162,118 Z' },
    { id: 'cow-eye', label: 'Eye', tone: 'dark', path: circlePath(125, 148, 8) },
    { id: 'cow-nose', label: 'Nose', tone: 'dark',
      path: 'M108,185 Q118,192 132,192 Q142,188 148,182 Q145,195 135,202 Q120,205 110,198 Q105,192 108,185 Z' },
    { id: 'cow-neck', label: 'Neck', tone: 'medium',
      path: 'M148,205 Q162,218 178,235 Q195,252 208,268 Q225,262 238,258 Q225,238 208,218 Q192,198 175,185 Q165,195 155,202 Z' },
    { id: 'cow-body', label: 'Body', tone: 'medium',
      path: 'M208,268 Q195,288 188,315 Q182,345 185,375 Q192,402 210,418 Q235,432 268,438 Q308,438 342,430 Q372,418 392,398 Q408,375 412,345 Q412,315 402,288 Q388,265 368,252 Q345,242 318,238 Q288,238 260,245 Q232,252 212,265 Z' },
    { id: 'cow-spot1', label: 'Spot 1', tone: 'dark',
      path: 'M248,295 Q262,282 282,278 Q302,282 312,298 Q318,318 308,335 Q295,345 275,342 Q258,335 252,318 Q248,308 248,295 Z' },
    { id: 'cow-spot2', label: 'Spot 2', tone: 'dark',
      path: 'M345,295 Q358,288 372,292 Q382,302 382,318 Q378,332 365,338 Q352,335 345,322 Q340,308 345,295 Z' },
    { id: 'cow-udder', label: 'Udder', tone: 'light',
      path: 'M268,428 Q275,438 282,445 Q290,448 298,445 Q305,438 312,428 Q308,442 298,452 Q288,455 278,452 Q268,445 268,428 Z' },
    { id: 'cow-leg-fl', label: 'Front Left', tone: 'dark',
      path: 'M215,418 Q208,435 205,452 Q202,462 205,468 Q212,472 218,468 Q220,458 222,442 Q225,430 228,422 Z' },
    { id: 'cow-leg-fr', label: 'Front Right', tone: 'dark',
      path: 'M248,432 Q242,445 240,458 Q238,465 240,472 Q248,475 252,472 Q255,462 255,448 Q255,438 255,432 Z' },
    { id: 'cow-leg-bl', label: 'Back Left', tone: 'dark',
      path: 'M345,425 Q340,440 338,455 Q335,465 338,472 Q345,475 352,472 Q355,462 355,448 Q355,438 352,428 Z' },
    { id: 'cow-leg-br', label: 'Back Right', tone: 'dark',
      path: 'M378,412 Q375,428 372,445 Q370,458 372,465 Q378,468 385,465 Q388,455 388,442 Q388,432 385,418 Z' },
    { id: 'cow-tail', label: 'Tail', tone: 'dark',
      path: 'M405,288 Q418,275 432,265 Q445,258 452,262 Q455,268 448,278 Q435,292 418,302 Q408,308 402,302 Z' },
  ],
  lightTextures: [], mediumTextures: [], darkTextures: [], accentTextures: [],
};
